...
<div style='text-align: center; margin-top: 30px;'>
    <span style='font-size: 32px; color: black; font-weight: bold;'>You owe nature <b>{tree_count}</b> tree{'s' if tree_count > 1 else ''} monthly.</span><br>
    {f"<a href='https://www.tema.org.tr/en/homepage' id='button-17' class='button-17' role='button' style='display: inline-block; margin-top: 18px; font-size: 28px; color: black; text-decoration: none; font-weight: bold;'>🌳 Proceed to offset 🌳</a>" if tree_count > 0 else ""}
</div>
"""
tab_result.markdown(centered_message, unsafe_allow_html=True)
